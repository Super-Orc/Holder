...
private[orco] object ThreadUtils {
  ...
  /**
    ...
    *   at ... run in separate thread using org.apache.holder.util.ThreadUtils ... ()
  ...
  def awaitResult[T](awaitable: Awaitable[T], atMost: Duration): T = {
    try {
      ...
      case NonFatal(t) if !t.isInstanceOf[TimeoutException] =>
        throw new HolderException("Exception thrown in awaitResult: ", t)
    }
  }
