...
import com.orco.holder.util.NextIterator
...
abstract class Serializer {
  ...
  /**
    ...
    *
    * This API is private to holder; this method should not be overridden in third-party subclasses
    * or called in user code and is subject to removal in future holder releases.
    *
    * See holder-7311 for more details.
    */
  private[holder] def supportsRelocationOfSerializedObjects: Boolean = false
}
