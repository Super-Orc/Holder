...
import com.orco.holder.util.{ThreadUtils, Utils}
...
/**
  ...
  */
private[holder] class RpcTimeout(val duration: FiniteDuration, val timeoutProp: String)
...
private[holder] object RpcTimeout {
  ...
  /**
    ...
    */
  def apply(conf: HolderConf, timeoutProp: String): RpcTimeout = {
  ...
  /**
    ...
    */
  def apply(conf: HolderConf, timeoutProp: String, defaultValue: String): RpcTimeout = {
  ...
  /**
    ...
    */
  def apply(conf: HolderConf, timeoutPropList: Seq[String], defaultValue: String): RpcTimeout = {
