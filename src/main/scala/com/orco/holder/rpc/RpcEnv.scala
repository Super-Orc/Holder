...
import com.orco.holder.rpc.netty.NettyRpcEnvFactory
...
/**
  ...
  */
private[holder] abstract class RpcEnv(conf: HolderConf) {

  private[holder] val defaultLookupTimeout = RpcUtils.lookupRpcTimeout(conf)
...
//    * RpcEnvFileServer use the "holder" scheme, this method will be called by the Utils class to
//    * retrieve the files.
//    *
...
/**
  ...
  * it can return "holder" URIs which will be handled by `RpcEnv#fetchFile`.
  */
//private[holder] trait RpcEnvFileServer {
//
//  /**
...
private[holder] case class RpcEnvConfig(
                                        conf: HolderConf,
                                        name: String,
                                        bindAddress: String,
                                        advertiseAddress: String,
