...
package com.orco.holder.network.protocol;

import com.google.common.base.Objects;
import io.netty.buffer.ByteBuf;

/** Response to {@link RpcRequest} for a failed RPC. */
public final class RpcFailure extends AbstractMessage implements com.orco.holder.network.protocol.ResponseMessage {
  ...
  public int encodedLength() {
    return 8 + com.orco.holder.network.protocol.Encoders.Strings.encodedLength(errorString);
  }

  @Override
  public void encode(ByteBuf buf) {
    buf.writeLong(requestId);
    com.orco.holder.network.protocol.Encoders.Strings.encode(buf, errorString);
  }

  public static RpcFailure decode(ByteBuf buf) {
    long requestId = buf.readLong();
    String errorString = com.orco.holder.network.protocol.Encoders.Strings.decode(buf);
