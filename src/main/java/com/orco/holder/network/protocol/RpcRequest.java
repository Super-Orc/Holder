...
import com.orco.holder.network.buffer.ManagedBuffer;
import com.orco.holder.network.buffer.NettyManagedBuffer;

/**
 * A generic RPC which is handled by a remote {@link com.orco.holder.network.server.RpcHandler}.
 * This will correspond to a single
 * {@link com.orco.holder.network.protocol.ResponseMessage} (either success or failure).
 */
