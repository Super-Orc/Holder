...
package com.orco.holder.network;

import com.orco.holder.network.client.TransportClient;
import com.orco.holder.network.client.TransportClientBootstrap;
import com.orco.holder.network.client.TransportClientFactory;
import com.orco.holder.network.client.TransportResponseHandler;
import com.orco.holder.network.protocol.MessageDecoder;
import com.orco.holder.network.protocol.MessageEncoder;
import com.orco.holder.network.server.*;
import com.orco.holder.network.util.NettyUtils;
import com.orco.holder.network.util.TransportConf;
import com.orco.holder.network.util.TransportFrameDecoder;
 ...
 * {@link com.orco.holder.network.server.TransportChannelHandler}.
 *
...
//  }
   ...
   * has a {@link com.orco.holder.network.server.TransportChannelHandler} to handle request or
   * response messages.
   *
