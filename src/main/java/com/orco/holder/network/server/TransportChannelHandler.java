...
package com.orco.holder.network.server;
...
import com.orco.holder.network.protocol.RequestMessage;
import com.orco.holder.network.protocol.ResponseMessage;
        ...
        if (e.state() == IdleState.ALL_IDLE && isActuallyOverdue) {
          if (responseHandler.numOutstandingRequests() > 0) {
            ...
            logger.error("Connection to {} has been quiet for {} ms while there are outstanding " +
              "requests. Assuming connection is dead; please adjust holder.network.timeout if " +
